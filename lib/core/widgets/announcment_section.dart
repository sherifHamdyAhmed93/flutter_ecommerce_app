...
class AnnouncmentSection extends StatefulWidget {
  AnnouncmentSection({super.key});

  @override
  State<AnnouncmentSection> createState() => _AnnouncmentSectionState();
}

class _AnnouncmentSectionState extends State<AnnouncmentSection> {
  int _current = 0;
